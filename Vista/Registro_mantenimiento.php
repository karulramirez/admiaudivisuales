...
<html lang="en">
  <head>
    ...
    <title>reparacion de equipos</title>
        ...
        <div class="right_col" role="main">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><small>Devolucion de equipos por matenimeinto </small></h2>
                  ...
                  <div class="x_content">
                      <div class="row">
                          <div class="col-sm-12">
                            <form method="POST" action="Registro_mantenimiento.php" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
